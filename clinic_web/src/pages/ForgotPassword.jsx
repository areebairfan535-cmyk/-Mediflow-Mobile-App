...
/**
 * Forgotten password (§11), clinic side.
 *
 * Same two steps as the patient app — email, then code and new password — in
 * the same two-pane shell as the login screen it replaces, so nobody wonders
 * whether they have left the right site.
 *
 * The left pane is about the one thing people get wrong here: an owner can
 * reset a colleague's password from inside the clinic, which is faster than
 * waiting for an email when the person is standing next to you.
 */
    ...
    <div className="auth-shell">
      <aside className="auth-aside">
        ...
        <ul className="auth-points">
          <li><b>Quicker still</b> — an owner can reset your password from inside the clinic</li>
          <li><b>Nothing is revealed</b> — the reply is the same for an address we do not know</li>
        </ul>

        <p className="auth-foot">
          Changing your password does not touch any patient record. It only
          changes who can reach one.
        </p>
      </aside>
